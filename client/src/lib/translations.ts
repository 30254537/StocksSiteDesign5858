...
export const translations: Translations = {
  ...
  zh: {
    ...
    // About Us
    "about.title": "关于我们",
    "about.content": "STONKS DEX SHOP 是区块链社区生态系统的先驱者和核心，致力于打造一个由社区成员共同拥有和主导的去中心化生态。我们的核心理念是「社区共建、共享、共治」，每一位持有 $STONKS 代币的社区成员不仅是平台的用户，更是生态系统的真正所有者，拥有参与治理和分享价值的权利。我们自豪地宣布，属于全体社区成员的去中心化交易平台 My STONKS 已正式测试上线！这标志着 STONKS DEX 生态系统迈出了革命性的一步，为区块链领域树立了社区共建的典范。My STONKS 将技术创新与社区治理完美结合，通过独特的「人人皆股东」模式，让每一位社区成员都能参与平台的决策和发展。我们相信，真正的区块链精神在于彻底的权力分散与共同所有，这使我们在加密货币领域独树一帜。在 STONKS DEX SHOP，我们不仅提供精心设计的周边产品，更构建了一个由社区成员主导的完整生态系统。我们通过线上线下活动、互动平台以及独家周边，连接全球区块链爱好者，促进文化交流与知识共享。选择 STONKS DEX SHOP，您不仅是在获取一件产品，更是在加入一个革命性的区块链社区生态，成为它的共同拥有者和建设者。我们的愿景是打造区块链世界中最具包容性和创新性的去中心化社区，通过集体智慧和协作，共同定义加密货币文化的未来。加入我们的 <a href='https://t.me/STONKSOPEN' target='_blank'>Telegram 社区</a>，获取 $STONKS，成为生态系统的共同所有者，与我们一起，STONKS TO THE MOON！",
    ...
    "checkout.sendStonksToAddress": "发送STONKS到地址:",
