...
export const translations: Translations = {
  ...
  zh: {
    ...
    // About Us
    "about.title": "关于我们",
    "about.content": "<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>关于MY STONKS与STONKS DEX SHOP\n\nSTONKS DEX SHOP是MY STONKS去中心化交易所的文化延伸，我们以创新与社区为核心，打造连接区块链技术与现实世界的桥梁。这里不仅是生态周边的展示平台，更是全球区块链爱好者共同参与、共同成长的协作网络。通过独特的设计与互动体验，我们致力于让每个人都能成为生态共建者，见证去中心化未来的无限可能。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>1.社区共治 权力共享\n\n持有MY STONKS平台代币即拥有生态话语权，同时皆为股东，共同治理，共享成果，彰显协作力量。\n无论是交易平台的升级方向，还是周边产品的设计理念，每位成员都能通过透明机制参与决策。我们相信，真正的创新源于集体智慧，而非单一中心。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>2.文化连接 打破边界\n\n从限量周边到线下活动，每一件产品、每一次互动都是传递区块链精神的载体。我们通过精心设计的文化符号，将技术理念转化为可感知的体验，让去中心化思想突破屏幕的界限，融入日常生活。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>3.价值循环，共享成长\n\n周边产品的收益将直接反哺MY STONKS生态建设，形成"消费-共建-增值"的闭环。购买一件周边，不仅是支持理念，更是推动整个社区向前的动力。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>4.实体化数字精神\n\n每款周边产品都承载着MY STONKS的核心理念。无论是印有社区宣言的潮品，还是融合平台数据的艺术装置，它们既是收藏品，也是参与生态的"钥匙"——持有者将解锁专属活动资格与社区荣誉身份。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>5.线上线下共振\n\n我们定期举办全球协作活动：从设计众创周、区块链文化沙龙，到用户提案落地计划，让线上讨论变为现实成果。在这里，灵感与行动从未如此接近。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>6.价值层共识\n\n周边销售额的30%自动注入MY STONKS流动性池，形成文化消费→资本增值→治理优化的飞轮效应。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>7.透明机制 信任为基\n\n所有生态决策、资金流向均通过公开渠道可查，社区成员可实时追踪每一份贡献如何转化为平台进展。这种开放性，正是我们对"去中心化"的真诚诠释。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg mb-6'>加入这场革新运动\n\nSTONKS DEX SHOP不属于某个团队，而是属于所有相信去中心化未来的人。无论你是开发者、设计师，还是区块链文化的传播者，这里都有属于你的角色：\n\n加入Telegram社区，获取MY STONKS代币，成为生态共建股东；\n\n参与周边共创计划，让你的设计成为社区文化符号；\n\n出席全球线下活动，与志同道合者探索区块链的更多可能。</div>\n\n<div class='border border-[#00ffcc]/30 p-5 rounded-lg'>我们正在书写一个新时代的故事——技术属于大众，价值回归社区，创新没有边界。\n\nSTONKS TO THE MOON，未来由你定义！\n→ <a href='https://t.me/STONKSOPEN' target='_blank'>立即加入社区</a> | <a href='/products'>探索周边系列</a>\n\nMY STONKS生态：因为相信，所以看见</div>",
