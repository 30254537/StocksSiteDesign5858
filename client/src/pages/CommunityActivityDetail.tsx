          ...
          {data.imageUrls && Array.isArray(data.imageUrls) && data.imageUrls.length > 0 ? (
              ...
              <div className="relative overflow-hidden rounded-lg group">
                ...
                <div className="relative cursor-pointer">
                  <img 
                    ...
                    className="w-full object-cover h-[320px] rounded-md"
                    onClick={() => {
                  ...
                  {data.imageUrls.map((imgUrl, index) => (
                    ...
                    >
                      <img 
                        ...
                        className="h-24 w-24 object-cover rounded-md border border-accent/20 hover:border-accent"
                      />
                    </div>
                  ))}
                </div>
            ...
            <div className="mb-6 relative cursor-pointer">
              <img 
                src={data.imageUrl} 
                alt={data.title} 
                className="w-full rounded-lg object-cover h-[320px]"
                onClick={() => {
