      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-sm md:prose-base lg:prose-lg prose-invert prose-headings:text-[#00ffcc] prose-a:text-[#00ffcc] hover:prose-a:text-[#00ffcc]/70 text-center">
          ...
          <div className="border border-[#00ffcc]/30 p-8 rounded-lg">
            ...
            <p className="text-[#00ffcc] font-bold">1.社区共治 权力共享</p>
            ...
            <p className="text-[#00ffcc] font-bold mt-6">3.价值循环 消费共建</p>
            <p>周边产品的部分收益将直接注入MY STONKS流动性池或反哺MY STONKS生态建设，形成"消费-共建-增值"的闭环。购买一件周边，不仅是支持理念，更是推动整个社区向前的动力。</p>
            
            <p className="text-[#00ffcc] font-bold mt-6">4.实体链接 数字精神</p>
            <p>每款周边产品都承载着MY STONKS的核心理念。无论是印有DEX的LOGO还是社区宣言的潮品，还是融合平台数据的艺术装置，它们既是收藏品，也是参与生态的"钥匙"——持有者将以周边为媒介，互动为桥梁，构建全球区块链爱好者的协作生态。</p>
            
            <p className="mt-6"></p>
            
            <p className="text-[#00ffcc] font-bold mt-6">5.线上线下 互动共振</p>
            <p>我们定期举办全球协作线下聚会活动：从设计众创周、MY STONKS文化沙龙，到用户提案落地计划，让线上讨论变为现实成果。在这里，灵感与行动从未如此接近。</p>
            
            <p className="text-[#00ffcc] font-bold mt-6">6.透明机制 信任为基</p>
            <p>所有生态决策、资金流向均通过公开渠道可查，社区成员可实时追踪每一份贡献如何转化为平台土壤。这种开放性，正是我们对"去中心化"的真诚诠释。</p>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="bg-primary/30 border border-accent/20 p-8 rounded-lg">
            ...
            <ul className="list-disc pl-5 text-left space-y-2 mb-6">
